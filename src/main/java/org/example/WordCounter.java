...
public class WordCounter {
    ...
    public static Map<String, Integer>calculatedWord() {
        ...
        for (String kelime : kelimeler) {
            kelime = kelime.toLowerCase().replaceAll("[,.?!]", ""); // Removing punctuation
